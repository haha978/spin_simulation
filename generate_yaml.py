...
def generate_AC_square_yaml():
    DATA_DIR_PATH = "/home/leom/spin_simulation/pulse_sequence_yaml"
    ...
    param_dict["spacing"] = 50.e-6
    with open(os.path.join(DATA_DIR_PATH, "AC_param_spacing_50e-6.yaml"), "w") as f:
